...
* Una máquina virtual Ubuntu (testeada en 22.04 LTS).
* Un Fully Qualified Domain Name (FQDN) para la VM.
* Un FQDN para instalar un servicio de Wordpress.
* Un FQDN para instalar un servicio de la demoapp.
* Una Demoapp para subirla a un repositorio público de contenedores.
